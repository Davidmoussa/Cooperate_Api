...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/layout/dashboard/dashboard.module.ts")).then((m) => m.DashboardModule)
            },
            { path: '', redirectTo: 'products', pathMatch: 'prefix' },
            {
                path: 'products',
                loadChildren: () => Promise.all(/*! import() | products-products-module */[__webpack_require__.e("common"), __webpack_require__.e("products-products-module")]).then(__webpack_require__.bind(null, /*! ./products/products.module */ "./src/app/layout/products/products.module.ts")).then((m) => m.ProductsModule)
            },
            ...
            {
                path: 'category',
                loadChildren: () => Promise.all(/*! import() | category-category-module */[__webpack_require__.e("common"), __webpack_require__.e("category-category-module")]).then(__webpack_require__.bind(null, /*! ./category/category.module */ "./src/app/layout/category/category.module.ts")).then((m) => m.CategoryModule)
            },
            ...
            {
                path: 'order',
                loadChildren: () => Promise.all(/*! import() | order-order-module */[__webpack_require__.e("common"), __webpack_require__.e("order-order-module")]).then(__webpack_require__.bind(null, /*! ./order/order.module */ "./src/app/layout/order/order.module.ts")).then((m) => m.OrderModule)
            },
            {
                path: 'users',
                loadChildren: () => Promise.all(/*! import() | users-users-module */[__webpack_require__.e("common"), __webpack_require__.e("users-users-module")]).then(__webpack_require__.bind(null, /*! ./users/users.module */ "./src/app/layout/users/users.module.ts")).then((m) => m.UsersModule)
            },
...
let CategoryService = class CategoryService {
    constructor(http) {
        this.http = http;
        this.apiUrl = "http://46.101.105.124/api/ProJectTypes";
        this.httpOptions = {
    ...
    getForm(id) {
        return this.http.get(`http://46.101.105.124/api/ProForms/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    update(id, post) {
...
let ProductService = class ProductService {
    constructor(http) {
        this.http = http;
        this.apiUrl = 'http://46.101.105.124/api/products';
    }
    getAll() {
        return this.http.get(this.apiUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
