  ...
  function srcAppSharedServicesRegistrationRequestsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegistrationRequestsService = /*#__PURE__*/function () {
      function RegistrationRequestsService(http) {
        ...
        this.http = http;
        this.apiUrl = 'https://api.egypt-youth.com:4430/api/Acount/Seallers/Requst';
        this.httpOptions = {
      ...
      _createClass(RegistrationRequestsService, [{
        ...
        value: function verify(acountId) {
          ...
          return this.http.post("https://api.egypt-youth.com:4430/api/Acount/Sealler/Confierm", JSON.stringify(body), this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "handleError",
